...
- **config/dev.toml** 파일을 열고 tag 정보가 **83f489b28c** 가 맞는지 확인합니다
  - 이미지 tag 는 git commit hash 값을 사용하며, 이를 통해 시스템을 항상 코드로 부터 재현가능(reproducible)하도록 합니다
